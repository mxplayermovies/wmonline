...
const clearmind_2024 = ({ movie }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebPage",
        "@id": "https://watchmoviesonline.vercel.app/movie/clearmind-2024/#webpage",
        "url": "https://watchmoviesonline.vercel.app/movie/clearmind-2024/",
      ...
      {
        "@type": "Article",
        "@id": "https://watchmoviesonline.vercel.app/movie/clearmind-2024/#article",
      ...
      {
        "@type": "BlogPosting",
        "@id": "https://watchmoviesonline.vercel.app/movie/clearmind-2024/#blogPost",
        "headline": `Watch ${movie.name} | Watch Movies Online™`,
        "datePublished": "2024-01-13T13:00:00+00:00",
        "dateModified": "2024-01-13T13:13:00+00:00",
        "articleSection": "Movie",
        ...
        "image": movie.image,
        "name": `Watch ${movie.name} | Watch Movies Online™`,
        "@id": "https://watchmoviesonline.vercel.app/movie/clearmind-2024/#richSnippet",
        "isPartOf": {
          "@id": "https://watchmoviesonline.vercel.app/movie/clearmind-2024/#webpage"
        },
        "inLanguage": "en-US",
